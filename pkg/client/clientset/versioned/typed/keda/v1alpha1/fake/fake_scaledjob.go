...
var scaledjobsResource = schema.GroupVersionResource{Group: "keda.k8s.io", Version: "v1alpha1", Resource: "scaledjobs"}

var scaledjobsKind = schema.GroupVersionKind{Group: "keda.k8s.io", Version: "v1alpha1", Kind: "ScaledJob"}
