...
func Get(ctx context.Context, selector string) v1alpha1.ScaledObjectInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/eventing-autoscaler-keda/third_party/pkg/client/informers/externalversions/keda/v1alpha1.ScaledObjectInformer with selector %s from context.", selector)
	}
